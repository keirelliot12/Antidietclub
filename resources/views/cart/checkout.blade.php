...
<head>
    ...
    <title>Checkout - Luwe & Cha-Ology</title>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-3xl shadow-soft p-6 md:p-8">
                    ...
                    <form action="{{ route('cart.whatsapp') }}" method="POST">
                        ...
                        <!-- Submit Button -->
                        <button type="submit"
                                class="w-full bg-[#25D366] text-white py-4 rounded-full font-heading text-xl hover:bg-[#1da851] transition-all duration-300 flex items-center justify-center gap-2">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-3xl shadow-soft p-6 md:p-8 sticky top-24">
                    ...
                    <div class="space-y-4 mb-6 max-h-64 overflow-y-auto">
                        ...
                        <div class="flex items-center gap-3 p-3 bg-offwhite rounded-xl border border-olive/20">
                            <div class="w-12 h-12 bg-gradient-to-br from-terra/30 to-olive/30 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <!-- Totals -->
                    <div class="border-t-2 border-dashed border-olive/30 pt-4 space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-orange">Calculated later</span>
                        </div>
